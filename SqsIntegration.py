...
class Integration(object):
    ...
    def start(self, queue_url, message_body_field, sent_datetime_field, wait_time_seconds = 10):
        ...
        while iteration_count < 200:
            ...
            for message in response['Messages']:
                self.create_trackor(message, message_body_field, sent_datetime_field)
                self.delete_message(message, queue_url)
    ...
    def create_trackor(self, message, message_body_field, sent_datetime_field):
