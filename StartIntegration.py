...
integration_name = settings_data["integrationName"]
...
sqsIntegration = Integration(ov_url, ov_access_key, ov_secret_key, ov_trackor_type, process_id, integration_name, 
